...
### Compute Instance
 ...
 1. Create a new instance by selecting the menu <img src="https://github.com/oracle-quickstart/oci-hpc-runbook-parabricks/blob/main/images/images/menu.png" height="20"> on the top left, then select Compute --> Instances. 
...
### Accessing a VNC
To connect to VNC via SSH tunnel, refer to the [README Post Processing](https://github.com/oracle-quickstart/oci-hpc-runbook-namd/blob/master/README.md#post-processing) section. 
